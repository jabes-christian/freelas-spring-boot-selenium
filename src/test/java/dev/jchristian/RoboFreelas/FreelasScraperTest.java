...
public class FreelasScraperTest {

    private WebDriver driver;
    private FreelasScraper scraper;

    @BeforeEach
    void setUp() {
        ChromeOptions options = new ChromeOptions();

        // Sem headless — browser abre visualmente para debug dos seletores
        ...
        scraper = new FreelasScraper(driver);
    }

    @Test
    void deveRetornarOportunidadesDo99Freelas() {
        List<OpportunityDTO> resultado = scraper.extrair();

        System.out.println("=== RESULTADO DA EXTRAÇÃO — 99Freelas ===");
        ...
        resultado.forEach(dto -> {
            ...
            System.out.println("Categoria : " + dto.valor());
